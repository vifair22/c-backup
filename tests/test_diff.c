...
static void test_snapshot_diff_output(void **state) {
    ...
    assert_non_null(out);
    assert_non_null(strstr(out, "M  c_backup_diff_src/a.txt\n"));
    assert_non_null(strstr(out, "m  c_backup_diff_src/b.txt\n"));
    assert_non_null(strstr(out, "D  c_backup_diff_src/gone.txt\n"));
    assert_non_null(strstr(out, "A  c_backup_diff_src/new.txt\n"));
    free(out);
}
